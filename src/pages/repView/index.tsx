...
import { defaultScrollbarOptions, metrics } from "../utils";
...
const RepoProfileComponent = ({ current, isRequesting, error }: IrepoView) => {
    ...
    React.useEffect(() => {
        dispatch(actionCreators.repoByIdRequest(Number(id)))
        return () => {
...
export const RepoProfile = connect(mapStateToProps)(RepoProfileComponent)